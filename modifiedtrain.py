...
if not os.path.exists("./logs/"):
    os.mkdir("./logs/")
log = Logger()
log.open("logs/modifiedresnext50ADD.txt")
log.write("\nModel Architecture: ResNeXt50+1FCN")
log.write("\nOptimiser: Adam")
...
## Add a new layer
# Example: Add a fully connected layer with 512 output features
num_features = model.fc.in_features  # Get the number of input features for the fully connected layer
new_layer = nn.Linear(num_features, 192)  # Add a new fully connected layer
model.fc=new_layer
